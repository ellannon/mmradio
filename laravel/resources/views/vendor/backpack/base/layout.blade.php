...
<body class="hold-transition {{Config::get('settings.admin_color_theme')}} {{ config('backpack.base.skin') }} sidebar-mini">
    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
            // Confirmar que volem canviar de idioma en el EDIT CRUD
            $(".js-selectLang").click(function(){
                if (confirm("{{ trans('backpack::langfilemanager.change_lang_confirm') }}") == true) {
                    return true;
                } else {
                    return false;
                }
